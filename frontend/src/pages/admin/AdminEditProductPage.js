...
import { Alert, Button, CloseButton, Col, Form, Image, Row, Table } from "react-bootstrap";
            ...
            <Col md={6}>
                ...
                <Form noValidate validated={validated} onSubmit={handleSubmit}>
                    <Form.Group className="mb-3" controlId="formBasicName">
                        ...
                        <Form.Control name="name" required type="text" defaultValue="Parasonic" />

                    </Form.Group>
                    <Form.Group className="mb-3" controlId="exampleForm.ControlTextareal">
                        <Form.Label>Description</Form.Label>
                        <Form.Control name="description" required type="textarea" row={3} defaultValue="Product description" />
                    </Form.Group>
                    ...
                    <Form.Group className="mb-3" controlId="formBasicPrice">
                        ...
                        <Form.Control name="price" required type="number" defaultValue="2" />
                    </Form.Group>
